...
public class BuscadorIngredientesCocina implements BuscadorIngredientes {

    @Override
    public void getStockElements(final IngredientesRetriever s, final int requestCode) {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child(Constantes.FIREBASE_INGREDIENTES_COCINA_NODE_NAME);
