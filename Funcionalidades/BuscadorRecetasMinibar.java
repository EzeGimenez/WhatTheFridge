...
/**
 * Implementación de buscador de recetas
 * <p>
 * Provee recetas de tragos y bebidas
 */
public class BuscadorRecetasMinibar implements BuscadorRecetas {
    private List<Receta> recetas;

    public BuscadorRecetasMinibar() {
